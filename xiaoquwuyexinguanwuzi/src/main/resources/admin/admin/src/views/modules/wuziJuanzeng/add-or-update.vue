        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuziJuanzengContent"  label="备注" prop="wuziJuanzengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziJuanzengContent" label="备注" prop="wuziJuanzengContent">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziJuanzengYesnoTypes" label="审核状态" prop="wuziJuanzengYesnoTypes">
                        <el-input v-model="ruleForm.wuziJuanzengYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.wuziJuanzengYesnoText" label="审核结果" prop="wuziJuanzengYesnoText">
