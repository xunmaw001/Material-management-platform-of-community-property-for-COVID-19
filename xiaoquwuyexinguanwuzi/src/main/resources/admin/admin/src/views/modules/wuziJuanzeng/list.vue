        ...
        <el-dialog title="审核" :visible.sync="wuziJuanzengYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.wuziJuanzengYesnoTypes" placeholder="请选择审核状态">
                        <el-option label="已同意" value="2"></el-option>
                        <el-option label="已拒绝" value="3"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="审核结果">
                    <el-input type="textarea" v-model="form.wuziJuanzengYesnoText" placeholder="审核结果"></el-input>
                </el-form-item>
            </el-form>
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '审核状态' : ''">
                        <el-select v-model="searchForm.wuziJuanzengYesnoTypes" placeholder="请选择审核状态">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoquwuyexinguanwuzi/upload/wuziJuanzengMuBan.xls"
                        >批量导入物资捐赠数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuziJuanzeng','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '审核状态': "wuziJuanzengYesnoValue",
                     '审核结果': "wuziJuanzengYesnoText",
                     '申请时间': "insertTime",
            },
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        types : 'wuzi_juanzeng_yesno_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
            ...
            wuziJuanzengUploadError(data){
                ...
                _this.form.wuziJuanzengYesnoTypes = "请选择审核状态";
                _this.wuziJuanzengYesnoTypesVisible = true;
            },

            wuziJuanzengYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.wuziJuanzengYesnoTypes == "请选择审核状态"){
