        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuziYuyueContent"  label="备注" prop="wuziYuyueContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuziYuyueContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuziYuyueContent" label="备注" prop="wuziYuyueContent">
                            <span v-html="ruleForm.wuziYuyueContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wuziYuyueContent = _this.ruleForm.wuziYuyueContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wuziYuyueContent = this.ruleForm.wuziYuyueContent.replaceAll(this.$base.url,"");
                        this.$http({
