    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                ...
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 6rpx 12rpx var(--publicSubColor)","margin":"6rpx 0rpx","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","color":"#333","textAlign":"left","borderRadius":"40rpx 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.forumPhone" type="text" v-model="ruleForm.forumPhone" placeholder="图片"></input>
            </view>
            <view
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.forumPhone) && (!this.$validate.isMobile(this.ruleForm.forumPhone))) {
                    this.$utils.msg(`图片不能为空并且需要输入正确格式`);
                    return
                }
