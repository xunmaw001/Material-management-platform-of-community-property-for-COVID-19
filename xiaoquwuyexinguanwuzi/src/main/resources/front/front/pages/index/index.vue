...
<view class="title"
    ...
    <view @tap="onDetailTap('news',item.id)" v-for="(item,index) in newsList" :key="index" class="list-item"
          :style='{"padding":"20rpx 12rpx","boxShadow":"-12rpx 12rpx 0 var(--publicSubColor)","margin":"0 auto 20rpx","borderColor":"#ccc","backgroundColor":"rgba(252, 252, 252, 1)","borderRadius":"0","borderWidth":"0","width":"46%","borderStyle":"solid","height":"auto"}'
          style="display: flex;flex-wrap: wrap;">
        <view
...
<view class="list-box4"
    ...
    <block v-for="(product,index) in wuziList" :key="index">
        <view v-if="index%6==0" @tap="onDetailTap('wuzi',product.id)" class="list-item"
            ...
            <image
                    ...
                    mode="aspectFill" :src="baseUrl+product.wuziPhoto">
            </image>
        ...
        <view v-if="index%6==1" @tap="onDetailTap('wuzi',product.id)"
        ...
        <view v-if="index%6==2" @tap="onDetailTap('wuzi',product.id)"
        ...
        <view v-if="index%6==3" @tap="onDetailTap('wuzi',product.id)" class="list-item"
        ...
        <view v-if="index%6==4" @tap="onDetailTap('wuzi',product.id)"
        ...
        <view v-if="index%6==5" @tap="onDetailTap('wuzi',product.id)"
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let wuzi = await this.$api.requestCondition('wuzi','gexingtuijian',wuziVal);

            this.wuziList = wuzi.data.list
            this.wuziList.forEach(function(item, index) {
                if(item.wuziContent != null && item.wuziContent != "" && item.wuziContent != "null"){
                    item.wuziContent =item.wuziContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
