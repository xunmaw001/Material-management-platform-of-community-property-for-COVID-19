        ...
        <form class="app-update-pv">
                ...
                <view
                    ...
                    <input   disabled
                             ...
                             :disabled="ro.wuziYuyueNumber" type="number" v-model="ruleForm.wuziYuyueNumber" placeholder="申请数量"></input>
                </view>
            <view
                ...
                <textarea :style='{"padding":"0 24rpx","boxShadow":"0px 6rpx 12rpx var(--publicSubColor)","margin":"6rpx 0rpx","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","color":"#333","textAlign":"left","borderRadius":"40rpx 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.wuziYuyueContent" v-model="ruleForm.wuziYuyueContent" placeholder="备注"/>
            </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let wuziYuyueYesnoTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'wuzi_yuyue_yesno_types',
            }
			let wuziYuyueYesnoTypes = await this.$api.page(`dictionary`, wuziYuyueYesnoTypesParams);
			this.wuziYuyueYesnoTypesOptions = wuziYuyueYesnoTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`wuziYuyue`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.wuziYuyueId){
                this.ruleForm.wuziYuyueId = options.wuziYuyueId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.wuziYuyueNumber) && (!this.$validate.isIntNumer(this.ruleForm.wuziYuyueNumber)) && this.ruleForm.wuziYuyueNumber >0) {
                    this.$utils.msg(`申请数量不能为空，不能小于0 格式为数字`);
                    return
                }
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`wuziYuyue`, this.ruleForm);
                } else {
                    await this.$api.save(`wuziYuyue`, this.ruleForm);
                }
