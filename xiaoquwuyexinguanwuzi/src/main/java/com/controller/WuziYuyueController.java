...
//        else if("用户".equals(role))
//            wuziYuyue.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(wuziYuyue.getWuziYuyueContent()) || "null".equals(wuziYuyue.getWuziYuyueContent())){
                wuziYuyue.setWuziYuyueContent(null);
        }
...
//                            wuziYuyueEntity.setWuziYuyueContent("");//详情和图片
