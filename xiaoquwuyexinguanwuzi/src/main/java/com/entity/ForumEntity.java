...
public class ForumEntity<T> implements Serializable {
    ...
    @TableField(value = "forum_phone")

    private String forumPhone;
    ...
    public void setForumPhone(String forumPhone) {
        this.forumPhone = forumPhone;
    }
    /**
	 * 获取：发布内容
	 */
